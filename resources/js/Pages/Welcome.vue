            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/#tentang-section"
                                >Tentang</a
                            >
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/#timeline-section"
                                >Timeline</a
                            >
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/#berita-section"
                                >Berita</a
                            >
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/#sponsor-section"
                                >Sponsor</a
                            >
                        </li>
                        <li class="nav-item">
                            <!-- <a class="nav-link" href="/kontak">Kontak</a> -->
                            <a class="nav-link" :href="route('pesan.create')"
                                >Kontak</a
                            >
                        </li>
                        <li class="nav-item">
                            ...
                            <template v-else>
                                <a class="nav-link common_btn" href="/dashboard"
                                    >Dashboard</a
                                >
                            </template>
                        </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-8">
                        <div
                            class="tf__banner_text wow fadeInUp"
                            v-for="setting in settings"
                            :key="setting.id"
                        >
                            <h1 class="teks-judul">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 wow fadeInRight">
                        <div>
                            ...
                            <div
                                class="tf__heading_area tf__heading_area_left mb_25"
                                v-for="setting in settings"
                                :key="setting.id"
                            >
        ...
        <section id="lomba-section" class="tf__categories mt_95">
            <div class="tf__activities_slider_area">
                <div class="container">
                    <div class="row">
                        <div
                            class="col-xl-6 col-md-8 col-lg-6 m-auto wow fadeInUp"
                        >
                                ...
                                <ul class="timeline">
                                    <li class="timeline-item left">
                                        <div class="timeline-body">
                                            ...
                                            <div
                                                class="timeline-content timeline-indicator"
                                            >
                                                <div
                                                    class="card border-0 shadow"
                                                >
                                                    <div
                                                        class="card-body p-xl-4"
                                                    >
                                                        <h3 class="cuyy">
                                                            PENDAFTARAN
                                                        </h3>
                                                        <p
                                                            class="card-text m-0 cuyyy"
                                                        >
                                                            Peserta mendaftar
