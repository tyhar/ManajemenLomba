                                ...
                                <div class="row">
                                    ...
                                    <div class="c-mb10">
                                        <label for="karya" class="form-label warna-hitam"><b>Pengumpulan
                                                Karya</b></label>
                                        <input type="date" class="form-control label-8 date370" id="karya" required />
                                    </div>
                                    <div class="c-mb10">
                                    ...
                                    <div class="c-mb10">
                                        <label for="finalis" class="form-label warna-hitam"><b>Pengumuman
                                                Finalis</b></label>
                                        <input type="date" class="form-control label-8 date370" id="finalis" required />
                                    </div>
                                    <div class="c-mb10">
                                    ...
                                    <div class="c-mb10">
                                        <label for="mulai" class="form-label warna-hitam"><b>Presentasi
                                                Finalis</b></label>
                                        <input type="date" class="form-control label-8 date370" required />
                                    </div>
                                    <div class="c-mb10">
