                            ...
                            <div>
                                ...
                                <div class="c-mb10">
                                    ...
                                    <input
                                        ...
                                        placeholder="Masukan sub judul event"
                                        id="sub_judul"
                                        required
                                    />
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 c-mb10">
                                        <label
                                            for="berakhir"
                                            class="form-label warna-hitam"
                                            ><b>Pendaftaran Berakhir</b></label
                                        >
                                        <input
                                            type="date"
                                            class="form-control label-8"
                                    ...
                                    <div class="c-mb10">
                                        <label
                                            ...
                                            class="c-mb5-black"
                                            ><b
                                                >Deskripsi Mulai Pendaftaran</b
                                            ></label
                                        >
                                        <textarea
                                            rows="2"
                                            placeholder="Masukan deskripsi mulai pendaftaran"
                                            id="descriptionaddl"
                                            required
                                        ></textarea>
                                    </div>
                                    ...
                                    <div class="c-mb10">
                                        <label
                                            ...
                                            class="c-mb5-black"
                                            ><b
                                                >Deskripsi Pengumpulan Karya</b
                                            ></label
                                        >
                                        <textarea
                                            rows="2"
                                            placeholder="Masukan deskripsi pengumpulan karya"
                                            id="descriptionaddl"
                                            required
                                        ></textarea>
                                    </div>
                                    ...
                                    <div class="c-mb10">
                                        <label
                                            ...
                                            class="c-mb5-black"
                                            ><b
                                                >Deskripsi Pengumuan Finalis</b
                                            ></label
                                        >
                                        <textarea
                                            rows="2"
                                            placeholder="Masukan deskripsi timeline"
                                            id="descriptionaddl"
                                            required
                                        ></textarea>
                                    </div>
                                    ...
                                    <div class="c-mb10">
                                        <label
                                            ...
                                            class="c-mb5-black"
                                            ><b
                                                >Deskripsi Presentasi Finalis</b
                                            ></label
                                        >
                                        <textarea
                                            rows="2"
                                ...
                                <div class="c-mb10">
                                    <label for="no_whatsapp" class="c-mb5-black"
                                        ><b>No WhatsApp</b></label
                                    >
                                    <input
                                        type="number"
                                        class="form-control"
                                ...
                                <div class="c-mb10">
                                    <label for="instagram" class="c-mb5-black"
                                        ><b>Instagram</b></label
                                    >
                                    <input
                                        type="text"
                                ...
                                <div class="c-mb10">
                                    <label for="email" class="c-mb5-black"
                                        ><b>Email</b></label
                                    >
                                    <input
                                        type="email"
                                        class="form-control"
                                        placeholder="Masukan email yang dapat dihubungi"
                                        id="email"
                                        required
                                    />
                                </div>
                                <div class="c-mb10">
                                    <label for="youtube" class="c-mb5-black"
                                        ><b>Youtube</b></label
                                    >
                                    <input
                                        type="text"
