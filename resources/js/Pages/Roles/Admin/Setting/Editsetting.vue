                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 c-mb10">
                                        <label for="mulai" class="c-mb5-black"><b>Tanggal Mulai</b></label>
                                    ...
                                    <div class="col-md-5 c-mb10">
                                        <label for="berakhir" class="c-mb5-black"><b>Tanggal Berakhir</b></label>
                                ...
                                <br>
                                <div class="c-mb10">
                                    <label for="logo2" class="c-mb5-black"><b>Logo 2 (background)</b>
                                    </label>
                                    <div class="m-2 p-2">
                                        <!-- <img :src="logo" class="w-32 h-32" style="width: 500px;" /> -->
                                ...
                                <div class="c-mb10">
                                    ...
                                    <input class="form-control" type="file"
                                        @input="form.logo3 = $event.target.files[0]" id="logo3" />
