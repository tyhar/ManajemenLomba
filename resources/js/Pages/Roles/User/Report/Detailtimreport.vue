...
const { userData, members, team, submissions, reg_lombas, lomba, kriterias, value, settings, log01 } = defineProps(['userData', 'members', 'team', 'submissions', 'reg_lombas', 'lomba', 'kriterias', 'value', 'settings', 'logo1']);
